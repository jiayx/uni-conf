...
const hooks = vi.hoisted(() => {
  ...
  settings: { language: 'en', theme: 'system', unmatchedTrafficPolicy: 'proxy', routingPolicyScenarios: ['ai-development', 'streaming', 'diagnostics'], exportNodeNamingMode: 'smart', showCompatibilityWarnings: true, ruleSetConversionPolicy: 'compatible', enableAutoRefresh: true, autoRefreshInterval: 240, autoNodeGroupsEnabled: true, autoNodeGroupTypes: ['url-test'], autoNodeGroupIncludeFlag: true, applySettings: vi.fn() },
  })
})
