...
const REQUIRED_REMOTE_RULE_SET_KEYS = [
  ...
  'source_override_risk_acknowledge',
  'source_override_risk_confirmation_required',
  'source_override_risk_strict_blocked',
  ...
  'validate_pending_sources',
  'validate_pending_sources_result',
