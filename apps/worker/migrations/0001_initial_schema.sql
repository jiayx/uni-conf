...
INSERT OR IGNORE INTO groups (id, name, type, collection_ids, group_ids, builtins, enabled, sort_order, is_builtin, created_at, updated_at) VALUES
  ...
  ('builtin-social',    'Social',    'select',   '[]', '["builtin-proxy"]', '[]', 1, 4,  1, datetime('now'), datetime('now')),
  ('builtin-github',    'GitHub',    'select',   '[]', '["builtin-proxy"]', '[]', 1, 5,  1, datetime('now'), datetime('now')),
  ('builtin-apple',     'Apple',     'select',   '[]', '["builtin-proxy"]', '[]', 1, 6,  1, datetime('now'), datetime('now')),
  ('builtin-microsoft', 'Microsoft', 'select',   '[]', '["builtin-proxy"]', '[]', 1, 7,  1, datetime('now'), datetime('now')),
  ('builtin-final',     '漏网之鱼',   'select',   '[]', '["builtin-proxy"]', '[]', 1, 8,  1, datetime('now'), datetime('now')),
  ('builtin-crypto',    'Crypto',    'select',   '[]', '["builtin-proxy"]', '[]', 0, 9,  1, datetime('now'), datetime('now')),
  ('builtin-gaming',    'Gaming',    'select',   '[]', '["builtin-proxy"]', '[]', 0, 10, 1, datetime('now'), datetime('now')),
  ('builtin-developer', 'Developer', 'select',   '[]', '["builtin-proxy"]', '[]', 0, 11, 1, datetime('now'), datetime('now')),
