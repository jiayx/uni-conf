...
const BUILTIN_TEMPLATES: BuiltinTemplate[] = [
  ...
  },
  {
    ...
    name: '社交媒体',
    nameEn: 'Social Media',
    description: '包含 Twitter/X、Instagram、Facebook、TikTok、Reddit、Discord 等社交媒体的分流规则',
    descriptionEn: 'Rules for Twitter/X, Instagram, Facebook, TikTok, Reddit, Discord and other social media',
    category: 'social',
  ...
  },
  {
    ...
    name: 'Telegram',
    nameEn: 'Telegram',
    description: 'Telegram 域名和常用 IP 段分流规则',
    descriptionEn: 'Rules for Telegram domains and common IP ranges',
    category: 'social',
  ...
  },
  {
    ...
    name: '广告拦截',
    nameEn: 'Ad Blocking',
    description: '常见广告、追踪和恶意域名拦截规则，使用 RULE-SET 指向知名拦截列表',
    descriptionEn: 'Common ad, tracking, and malicious domain blocking rules using RULE-SET blocklists',
    category: 'privacy',
